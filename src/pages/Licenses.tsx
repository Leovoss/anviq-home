...
const FORKS = [
  {
    name: 'Laya',
    href: 'https://github.com/Leovoss/laya',
    description: 'Anviq-maintained fork. Not currently used as a dependency of this website.',
  },
  {
    name: 'Rakazo Agent Engine',
    href: 'https://github.com/Leovoss/rakazo',
    description: 'Anviq-maintained fork for agent-engine work. Not currently used as a dependency of this website.',
  },
  {
    name: 'OpenShip',
    href: 'https://github.com/Leovoss/openship',
    description: 'Anviq-maintained fork. Not currently used as a dependency of this website.',
  },
] as const
...
export function Licenses() {
  return (
    <DocumentPage title="Open Source Licenses & Attributions">
      <p className="legal-updated">Last updated: 21 September 2026</p>
      <div className="legal-copy">
        <p>
          Anviq platform services and products may incorporate third-party open-source software. This page records
          the repositories currently maintained as Anviq forks and the upstream license terms relevant to their
          original open-source code.
        </p>
        <p>
          These repositories are not currently used as dependencies by this website. Before distributing a product
          that includes code from a fork, we review the upstream repository, retained notices, and the applicable
          license for that release.
        </p>

        <h2>Forks and attributions</h2>
        {FORKS.map((fork) => (
          <section key={fork.href} className="mb-6 rounded-lg border border-ash bg-chalk p-5">
            <h3 className="m-0 text-[18px] font-semibold text-black">{fork.name}</h3>
            <p className="mt-2">{fork.description}</p>
            <p className="mb-0">
              <strong>Repository:</strong>{' '}
              <a href={fork.href} target="_blank" rel="noopener noreferrer">
                {fork.href}
              </a>
              <br />
              <strong>Anviq modifications:</strong> private and proprietary; not licensed for redistribution under
              Apache-2.0.
              <br />
              <strong>Original-work license and notices:</strong> Apache License, Version 2.0 applies to the
              upstream code where applicable. Retain the copyright, license, and NOTICE information present in the
              upstream repository before distributing any derivative work.
            </p>
          </section>
        ))}
        ...
        <p>
          ...
          . The canonical text is reproduced below for convenience.
        </p>
        <pre className="legal-license-text">{APACHE_LICENSE}</pre>
      </div>
    </DocumentPage>
  )
}
